<template>
  <div>
    ...
    <OurStory v-if="showComponentB" />
    <MainMenu v-if="showComponentC" />
...
const showComponentB = true; // Set to true to display ComponentB
const showComponentC = true;
const showComponentD = true;
